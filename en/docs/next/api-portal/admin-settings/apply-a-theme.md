...
canonical_url: https://wso2.com/api-platform/docs/cloud/api-portal/admin-settings/apply-a-theme/
md_url: https://wso2.com/api-platform/docs/cloud/api-portal/admin-settings/apply-a-theme.md
tags:
  - cloud
  - api-portal
  - theming
