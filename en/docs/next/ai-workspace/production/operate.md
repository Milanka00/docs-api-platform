...
canonical_url: https://wso2.com/api-platform/docs/next/ai-workspace/production/operate/
md_url: https://wso2.com/api-platform/docs/next/ai-workspace/production/operate.md
tags:
  - ai-workspace
  - production
  - operations
...
| The RS256 JWT keypair, in `file` or `internal_token` mode | Once, when created, and after any rotation | Your secret manager |
| Configuration and values files | On every change | Version control, with secrets referenced rather than written |
